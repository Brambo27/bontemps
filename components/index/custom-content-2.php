<div class="custom-default custom-content-2">
    <div class="row">
        <div class="col-md-3">
            <img src="..\bontemps\images\page-1_img7.jpg">
        </div>
        <div class="col-md-9">
            <div class="custom-content-2">
                ...
                <p>
                    ...
                    Deze wordt later vervangen door de uiteindelijke tekst, die nu nog niet bekend is.
